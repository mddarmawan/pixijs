...
export class AbstractBatchRenderer extends ObjectRenderer
{
     ...
     */
    public size: number = settings.SPRITE_BATCH_SIZE * 4;
     ...
     */
    protected shaderGenerator: BatchShaderGenerator = null;

    /**
     * The class that represents the geometry of objects
     * that are going to be batched with this.
     *
     * @type {PIXI.BatchGeometry}
     */
    protected geometryClass: typeof BatchGeometry = null;
     ...
     * @readonly
     */
    protected vertexSize: number = null;
     ...
     * @private
     */
    protected _aBuffers: Array<ViewableBuffer> = {} as any;
     ...
     * @private
     */
    protected _iBuffers: Array<Uint16Array> = {} as any;
     ...
     */
    private _packedGeometryPoolSize = 2;

    protected _dcIndex = 0;
    protected _aIndex = 0;
    protected _iIndex = 0;
    protected _attributeBuffer: ViewableBuffer = null;
    protected _indexBuffer: Uint16Array = null;
